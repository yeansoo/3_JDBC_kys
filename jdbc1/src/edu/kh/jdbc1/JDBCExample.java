...
public class JDBCExample {
	public static void main(String[] args) {
		// JDBC : Java에서 DB에 접근할 수 있게 해주는 Java Programming API
		//											(Java에 기본 내장된 인터페이스)
		// java.sql 패키지에서 제공
		...
		// 생성된 결과(ResultSet, 성공한 행의 개수)를 반환하는데 사용되는 객체
		...
		try {
			...
			String ip="localhost"; // DB서버 컴퓨터 
			// localhost == 127.0.0.1( look back ip )
			
			String port=":1521"; // 포트번ㄴ호
			// 1521(기본값)
			// 9000 (서버컴)
			...
			// 3단계 : SQL을 수행해서 반환 받은 결과 ResultSet)를 한 행ㅆ기 
			// 접근해서 컬럼 값 얻어오기
